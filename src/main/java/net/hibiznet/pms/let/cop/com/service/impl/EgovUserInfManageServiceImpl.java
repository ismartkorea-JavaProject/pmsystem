...
public class EgovUserInfManageServiceImpl extends EgovAbstractServiceImpl implements EgovUserInfManageService {
     ...
     * 동호회 운영자 목록을 조회한다.
     * 
     * @see net.hibiznet.pms.let.cop.com.service.EgovUserInfManageService#selectClubOprtrList(net.hibiznet.pms.let.cop.com.service.UserInfVO)
     */
     ...
     * 동호회 사용자 목록을 조회한다.
     * 
     * @see net.hibiznet.pms.let.cop.com.service.EgovUserInfManageService#selectClubUserList(net.hibiznet.pms.let.cop.com.service.UserInfVO)
     */
     ...
     * 커뮤니티 관리자 목록을 조회한다.
     * 
     * @see net.hibiznet.pms.let.cop.com.service.EgovUserInfManageService#selectCmmntyMngrList(net.hibiznet.pms.let.cop.com.service.UserInfVO)
     */
     ...
     * 커뮤니티 사용자 목록을 조회한다.
     * 
     * @see net.hibiznet.pms.let.cop.com.service.EgovUserInfManageService#selectCmmntyUserList(net.hibiznet.pms.let.cop.com.service.UserInfVO)
     */
     ...
     * 사용자 정보에 대한 목록을 조회한다.
     * 
     * @see net.hibiznet.pms.let.cop.com.service.EgovUserInfManageService#selectUserList(net.hibiznet.pms.let.cop.com.service.UserInfVO)
     */
     ...
     * 
     * @see net.hibiznet.pms.let.cop.com.service.EgovUserInfManageService#selectAllClubUser(net.hibiznet.pms.let.cop.com.service.UserInfVO)
     */
     ...
     * 
     * @see net.hibiznet.pms.let.cop.com.service.EgovUserInfManageService#selectAllCmmntyUser(net.hibiznet.pms.let.cop.com.service.UserInfVO)
     */
