package net.hibiznet.pms.let.cop.bbs.service.impl;
import java.util.HashMap;
import java.util.Iterator;
import java.util.List;
import java.util.Map;

import net.hibiznet.pms.let.cop.bbs.service.BoardMaster;
import net.hibiznet.pms.let.cop.bbs.service.BoardMasterVO;
import net.hibiznet.pms.let.cop.bbs.service.EgovBBSAttributeManageService;
import net.hibiznet.pms.let.cop.com.service.BoardUseInf;
import net.hibiznet.pms.let.cop.com.service.EgovUserInfManageService;
import net.hibiznet.pms.let.cop.com.service.UserInfVO;
import net.hibiznet.pms.let.cop.com.service.impl.BBSUseInfoManageDAO;
...
public class EgovBBSAttributeManageServiceImpl extends EgovAbstractServiceImpl implements EgovBBSAttributeManageService {
     ...
     * 등록된 게시판 속성정보를 삭제한다.
     *
     * @see net.hibiznet.pms.let.cop.bbs.brd.service.EgovBBSAttributeManageService#deleteBBSMasterInf(net.hibiznet.pms.let.cop.bbs.brd.service.BoardMaster)
     */
     ...
     * 신규 게시판 속성정보를 생성한다.
     *
     * @see net.hibiznet.pms.let.cop.bbs.brd.service.EgovBBSAttributeManageService#insertBBSMastetInf(net.hibiznet.pms.let.cop.bbs.brd.service.BoardMaster)
     */
     ...
     *
     * @see net.hibiznet.pms.let.cop.bbs.brd.service.EgovBBSAttributeManageService#selectAllBBSMasteInf(net.hibiznet.pms.let.cop.bbs.brd.service.BoardMasterVO)
     */
     ...
     *
     * @see net.hibiznet.pms.let.cop.bbs.brd.service.EgovBBSAttributeManageService#selectBBSMasterInf(net.hibiznet.pms.let.cop.bbs.brd.service.BoardMasterVO)
     */
     ...
     * 게시판 속성 정보의 목록을 조회 한다.
     *
     * @see net.hibiznet.pms.let.cop.bbs.brd.service.EgovBBSAttributeManageService#selectBBSMasterInfs(net.hibiznet.pms.let.cop.bbs.brd.service.BoardMasterVO)
     */
     ...
     * 게시판 속성정보를 수정한다.
     *
     * @see net.hibiznet.pms.let.cop.bbs.brd.service.EgovBBSAttributeManageService#updateBBSMasterInf(net.hibiznet.pms.let.cop.bbs.brd.service.BoardMaster)
     */
     ...
     * 템플릿의 유효여부를 점검한다.
     *
     * @see net.hibiznet.pms.let.cop.bbs.brd.service.EgovBBSAttributeManageService#validateTemplate(net.hibiznet.pms.let.cop.bbs.brd.service.BoardMasterVO)
     */
