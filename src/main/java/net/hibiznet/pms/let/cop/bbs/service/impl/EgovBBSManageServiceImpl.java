...
import net.hibiznet.pms.let.cop.bbs.service.Board;
import net.hibiznet.pms.let.cop.bbs.service.BoardVO;
import net.hibiznet.pms.let.cop.bbs.service.EgovBBSManageService;
import net.hibiznet.pms.let.utl.fcc.service.EgovDateUtil;
...
public class EgovBBSManageServiceImpl extends EgovAbstractServiceImpl implements EgovBBSManageService {
     ...
     * 게시물 한 건을 삭제 한다.
     *
     * @see net.hibiznet.pms.let.cop.bbs.brd.service.EgovBBSManageService#deleteBoardArticle(net.hibiznet.pms.let.cop.bbs.brd.service.Board)
     */
     ...
     *
     * @see net.hibiznet.pms.let.cop.bbs.brd.service.EgovBBSManageService#insertBoardArticle(net.hibiznet.pms.let.cop.bbs.brd.service.Board)
     */
     ...
     *
     * @see net.hibiznet.pms.let.cop.bbs.brd.service.EgovBBSManageService#selectBoardArticle(net.hibiznet.pms.let.cop.bbs.brd.service.BoardVO)
     */
     ...
     *
     * @see net.hibiznet.pms.let.cop.bbs.brd.service.EgovBBSManageService#selectBoardArticles(net.hibiznet.pms.let.cop.bbs.brd.service.BoardVO)
     */
     ...
     * 게시물 한 건의 내용을 수정 한다.
     *
     * @see net.hibiznet.pms.let.cop.bbs.brd.service.EgovBBSManageService#updateBoardArticle(net.hibiznet.pms.let.cop.bbs.brd.service.Board)
     */
     ...
     * 방명록 내용을 삭제 한다.
     *
     * @see net.hibiznet.pms.let.cop.bbs.brd.service.EgovBBSManageService#deleteGuestList(net.hibiznet.pms.let.cop.bbs.brd.service.BoardVO)
     */
     ...
     * 방명록에 대한 목록을 조회 한다.
     *
     * @see net.hibiznet.pms.let.cop.bbs.brd.service.EgovBBSManageService#selectGuestList(net.hibiznet.pms.let.cop.bbs.brd.service.BoardVO)
     */
